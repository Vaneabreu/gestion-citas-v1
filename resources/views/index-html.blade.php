        ...
        <div class="main-img">
            <div class="container">
                ...
                <div class="d-flex justify-content-center align-items-center">
                    <div>
                        <a class="btn btn-light bg-white" target="_blank" href="https://templates.iqonic.design/hope-ui/html/dist/dashboard/">
                    ...
                    <div class="ms-3">
                        <a class="btn btn-light bg-white d-flex " href="https://github.com/iqonicdesignofficial/hope-ui-design-system"><img src="./assets/images/brands/github.png" width="24px" height="24px"><span class="text-danger mx-2 fw-bold">STAR US</span> <span>ON GITHUB</span></a>
                    </div>
                </div>
                    ...
                    <div class="bd-heading sticky-xl-top align-self-start">
                        <div class="card">
                            <div class="card-body">
                                <h5>Calendar</h5>
                                <div class="d-flex align-items-center mt-2">
                                    <a class="d-flex" href="https://templates.iqonic.design/hope-ui/documentation/html/dist/plugins/vanila-datepicker.html" target="_blank">
                                        <svg width="20" class="me-1" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path fill-rule="evenodd" clip-rule="evenodd" d="M12 21.2498C17.108 21.2498 21.25 17.1088 21.25 11.9998C21.25 6.89176 17.108 2.74976 12 2.74976C6.892 2.74976 2.75 6.89176 2.75 11.9998C2.75 17.1088 6.892 21.2498 12 21.2498Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                                            <path d="M10.5576 15.4709L14.0436 11.9999L10.5576 8.52895" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                                        </svg>
                    ...
                    <div class="bd-heading sticky-xl-top align-self-start">
                        <div class="card">
                            <div class="card-body">
                                <h5>Overview</h5>
                                <div class="d-flex align-items-center mt-2">
                                    <a class="d-flex disabled btn p-0" href="https://templates.iqonic.design/hope-ui/documentation/html/dist/main/" target="_blank">
                                        <svg width="20" class="me-1" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path fill-rule="evenodd" clip-rule="evenodd" d="M12 21.2498C17.108 21.2498 21.25 17.1088 21.25 11.9998C21.25 6.89176 17.108 2.74976 12 2.74976C6.892 2.74976 2.75 6.89176 2.75 11.9998C2.75 17.1088 6.892 21.2498 12 21.2498Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                                            <path d="M10.5576 15.4709L14.0436 11.9999L10.5576 8.52895" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                                        </svg>
